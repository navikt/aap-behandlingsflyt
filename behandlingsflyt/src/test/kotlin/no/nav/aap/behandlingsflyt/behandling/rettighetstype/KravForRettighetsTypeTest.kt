...
import no.nav.aap.vilkårsresultat.Avslagsårsak.BRUKER_OVER_67
import no.nav.aap.vilkårsresultat.Avslagsårsak.IKKE_BEHOV_FOR_OPPFOLGING
import no.nav.aap.vilkårsresultat.Avslagsårsak.VARIGHET_OVERSKREDET_OVERGANG_UFORE
...
import no.nav.aap.vilkårsresultat.Vilkårtype.AKTIVITETSPLIKT
import no.nav.aap.vilkårsresultat.Vilkårtype.ALDERSVILKÅRET
import no.nav.aap.vilkårsresultat.Vilkårtype.BISTANDSVILKÅRET
import no.nav.aap.vilkårsresultat.Vilkårtype.GRUNNLAGET
import no.nav.aap.vilkårsresultat.Vilkårtype.INNTEKTSBORTFALL
import no.nav.aap.vilkårsresultat.Vilkårtype.LOVVALG
import no.nav.aap.vilkårsresultat.Vilkårtype.MEDLEMSKAP
import no.nav.aap.vilkårsresultat.Vilkårtype.OPPHOLDSKRAV
import no.nav.aap.vilkårsresultat.Vilkårtype.OVERGANGARBEIDVILKÅRET
import no.nav.aap.vilkårsresultat.Vilkårtype.OVERGANGUFØREVILKÅRET
import no.nav.aap.vilkårsresultat.Vilkårtype.SAMORDNING
import no.nav.aap.vilkårsresultat.Vilkårtype.SAMORDNING_ANNEN_LOVGIVNING
import no.nav.aap.vilkårsresultat.Vilkårtype.STRAFFEGJENNOMFØRING
import no.nav.aap.vilkårsresultat.Vilkårtype.STUDENT
import no.nav.aap.vilkårsresultat.Vilkårtype.SYKDOMSVILKÅRET
import no.nav.aap.vilkårsresultat.Vilkårtype.SYKEPENGEERSTATNING
