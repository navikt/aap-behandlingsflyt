...
class GrunnbeløpTest {
    ...
    fun `aktiverGJustering2026 legger til grunnbeløp for 2026`() {
        ...
        assertThat(Grunnbeløp.finnGrunnbeløp(1 mai 2026)).isEqualTo(Beløp(136_549))
        assertThat(Grunnbeløp.gjennomsnittGrunnbeløp(1 mai 2026)).isEqualTo(Beløp(134_419))
    }
