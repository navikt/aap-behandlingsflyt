...
import no.nav.aap.underveis.MeldepliktStatus.FØR_VEDTAK
import no.nav.aap.underveis.MeldepliktStatus.IKKE_MELDT_SEG
...
import no.nav.aap.underveis.UnderveisÅrsak.MELDEPLIKT_FRIST_IKKE_PASSERT
...
class MeldeperiodeTilMeldekortBackendJobbUtførerTest {
    ...
    @Test
    fun `har opplysningsplikt selv om meldeplikt ikke er overholdt`() {
