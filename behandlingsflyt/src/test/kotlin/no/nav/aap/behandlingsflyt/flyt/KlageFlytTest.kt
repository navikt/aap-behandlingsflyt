...
import no.nav.aap.behandlingsflyt.avklaringsbehov.løsning.BekreftTotalvurderingKlageLøsning
import no.nav.aap.behandlingsflyt.avklaringsbehov.løsning.FastsettBehandlendeEnhetLøsning
import no.nav.aap.behandlingsflyt.avklaringsbehov.løsning.FastsettFullmektigLøsning
import no.nav.aap.behandlingsflyt.avklaringsbehov.løsning.FastsettPåklagetBehandlingLøsning
import no.nav.aap.behandlingsflyt.avklaringsbehov.løsning.FatteVedtakLøsning
import no.nav.aap.behandlingsflyt.avklaringsbehov.løsning.FullmektigLøsningDto
import no.nav.aap.behandlingsflyt.avklaringsbehov.løsning.HåndterSvarFraAndreinstansLøsning
import no.nav.aap.behandlingsflyt.avklaringsbehov.løsning.HåndterSvarFraAndreinstansLøsningDto
import no.nav.aap.behandlingsflyt.avklaringsbehov.løsning.SkrivBrevAvklaringsbehovLøsning
import no.nav.aap.behandlingsflyt.avklaringsbehov.løsning.SkrivForhåndsvarselKlageFormkravBrevLøsning
import no.nav.aap.behandlingsflyt.avklaringsbehov.løsning.TrekkKlageLøsning
import no.nav.aap.behandlingsflyt.avklaringsbehov.løsning.VentePåFristForhåndsvarselKlageFormkravLøsning
import no.nav.aap.behandlingsflyt.avklaringsbehov.løsning.VurderFormkravLøsning
import no.nav.aap.behandlingsflyt.avklaringsbehov.løsning.VurderKlageKontorLøsning
import no.nav.aap.behandlingsflyt.avklaringsbehov.løsning.VurderKlageNayLøsning
...
class KlageFlytTest : AbstraktFlytOrkestratorTest(KlageFlytTestUnleash::class) {
    ...
    fun `Teste Klageflyt - Omgjøring av 22-13 og revurdering genereres `() {
        ...
        val klagebehandling = sak.sendInnKlage(
            ...
            val klageDokumenter =
                mottattDokumentRepository.hentDokumenterAvType(behandling.id, InnsendingType.KLAGE)
