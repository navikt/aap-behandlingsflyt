...
import no.nav.aap.rettighetstype.KravForOrdinærAap
import no.nav.aap.rettighetstype.KravForOvergangArbeid
import no.nav.aap.rettighetstype.KravForOvergangUføretrygd
import no.nav.aap.rettighetstype.KravForStudent
import no.nav.aap.rettighetstype.KravForSykepengeerstatning
...
import no.nav.aap.underveis.VarighetVurdering.Avslagsårsak.ORDINÆRKVOTE_BRUKT_OPP
import no.nav.aap.underveis.VarighetVurdering.Avslagsårsak.SYKEPENGEERSTATNINGKVOTE_BRUKT_OPP
import no.nav.aap.underveis.UnderveisÅrsak
import no.nav.aap.underveis.UnderveisÅrsak.IKKE_GRUNNLEGGENDE_RETT
import no.nav.aap.underveis.UnderveisÅrsak.VARIGHETSKVOTE_BRUKT_OPP
