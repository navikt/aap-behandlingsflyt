...
import no.nav.aap.behandlingsflyt.avklaringsbehov.løsning.AvklarOvergangArbeidLøsning
import no.nav.aap.behandlingsflyt.avklaringsbehov.løsning.AvklarOvergangUføreLøsning
import no.nav.aap.behandlingsflyt.avklaringsbehov.løsning.AvklarPeriodisertForutgåendeMedlemskapLøsning
import no.nav.aap.behandlingsflyt.avklaringsbehov.løsning.AvklarPeriodisertLovvalgMedlemskapLøsning
import no.nav.aap.behandlingsflyt.avklaringsbehov.løsning.AvklarPeriodisertOverstyrtLovvalgMedlemskapLøsning
import no.nav.aap.behandlingsflyt.avklaringsbehov.løsning.AvklarSamordningAndreStatligeYtelserLøsning
import no.nav.aap.behandlingsflyt.avklaringsbehov.løsning.AvklarSamordningArbeidsgiverLøsning
import no.nav.aap.behandlingsflyt.avklaringsbehov.løsning.AvklarSamordningGraderingLøsning
import no.nav.aap.behandlingsflyt.avklaringsbehov.løsning.AvklarSamordningSykestipendLøsning
...
import no.nav.aap.behandlingsflyt.avklaringsbehov.løsning.AvklarYrkesskadeLøsning
import no.nav.aap.behandlingsflyt.avklaringsbehov.løsning.AvklaringsbehovLøsning
import no.nav.aap.behandlingsflyt.avklaringsbehov.løsning.BekreftVurderingerOppfølgingLøsning
import no.nav.aap.behandlingsflyt.avklaringsbehov.løsning.FastsettBeregningstidspunktLøsning
import no.nav.aap.behandlingsflyt.avklaringsbehov.løsning.FastsettYrkesskadeInntektLøsning
...
import no.nav.aap.behandlingsflyt.avklaringsbehov.løsning.PeriodisertAvklarSykepengerErstatningLøsning
import no.nav.aap.behandlingsflyt.avklaringsbehov.løsning.PeriodisertFritakMeldepliktLøsning
import no.nav.aap.behandlingsflyt.avklaringsbehov.løsning.RefusjonkravLøsning
import no.nav.aap.behandlingsflyt.avklaringsbehov.løsning.SkrivBrevAvklaringsbehovLøsning
import no.nav.aap.behandlingsflyt.avklaringsbehov.løsning.SkrivVedtaksbrevKlageLøsning
import no.nav.aap.behandlingsflyt.avklaringsbehov.løsning.SkrivVedtaksbrevLøsning
import no.nav.aap.behandlingsflyt.avklaringsbehov.løsning.SykdomsvurderingForBrevLøsning
import no.nav.aap.behandlingsflyt.avklaringsbehov.løsning.VurderInntektsbortfallLøsning
import no.nav.aap.behandlingsflyt.avklaringsbehov.løsning.VurderRettighetsperiodeLøsning
import no.nav.aap.behandlingsflyt.avklaringsbehov.løsning.YrkesskadeSakDto
import no.nav.aap.behandlingsflyt.avklaringsbehov.løsning.YrkesskadevurderingDto
...
import no.nav.aap.behandlingsflyt.steg.oppholdskrav.AvklarOppholdkravLøsningForPeriodeDto
...
import no.nav.aap.behandlingsflyt.steg.lovvalg.LovvalgDto
import no.nav.aap.behandlingsflyt.steg.lovvalg.MedlemskapDto
import no.nav.aap.behandlingsflyt.steg.medlemskap.PeriodisertManuellVurderingForForutgåendeMedlemskapDto
import no.nav.aap.behandlingsflyt.steg.lovvalg.PeriodisertManuellVurderingForLovvalgMedlemskapDto
...
import no.nav.aap.behandlingsflyt.steg.rettighetsperiode.RettighetsperiodeVurderingDTO
...
import no.nav.aap.behandlingsflyt.steg.samordning.andrestatligeytelservurdering.SamordningAndreStatligeYtelserVurderingDto
import no.nav.aap.behandlingsflyt.steg.samordning.arbeidsgiver.SamordningArbeidsgiverVurderingerDTO
...
open class AbstraktFlytOrkestratorTest(
    ...
    fun happyCaseFørstegangsbehandling(
        ...
        behandling = behandling
            ...
            .medKontekst {
                if (person.uføre != null) {
                    this.behandling.løsAvklaringsBehov(
                        AvklarSamordningUføreLøsning(
                            samordningUføreVurdering = SamordningUføreVurderingDto(
                                begrunnelse = "Samordning",
                                vurderingPerioder = listOf(
                                    SamordningUføreVurderingPeriodeDto(
                                        person.uføre!!.virkningstidspunkt,
                                        person.uføre!!.uføregrad.prosentverdi()
                                    )
                                )
                            )
                        )
    ...
    protected fun Behandling.løsArbeidsgiver(perioder: List<Periode>): Behandling {
        return this.løsAvklaringsBehov(
    ...
    protected fun Behandling.foreslåVedtak(): Behandling {
        return løsForeslåVedtak()
    }
