...
@Suppress("unused")
class KlagebehandlingKontorVisningUtleder(private val behandlendeEnhetRepository: BehandlendeEnhetRepository) :
    ...
    override fun skalVises(behandlingId: BehandlingId): Boolean {
        return behandlendeEnhetRepository.hentHvisEksisterer(behandlingId)?.vurdering?.skalBehandlesAvKontor == true
    }

    override fun gruppe(): StegGruppe {
        return StegGruppe.KLAGEBEHANDLING_KONTOR
    }
}