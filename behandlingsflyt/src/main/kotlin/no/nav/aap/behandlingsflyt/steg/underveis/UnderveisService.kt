package no.nav.aap.behandlingsflyt.steg.underveis
...
import no.nav.aap.behandlingsflyt.steg.underveis.regler.AapEtterRegel
...
class UnderveisService(
    ...
    companion object {
        ...
        fun tilUnderveisperioder(vurderRegler: Tidslinje<Vurdering>): List<Underveisperiode> =
        ...
        fun vurderRegler(input: UnderveisInput): Tidslinje<Vurdering> {
