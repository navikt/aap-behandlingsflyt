...
import no.nav.aap.behandlingsflyt.avklaringsbehov.løser.SkrivVedtaksbrevKlageLøser
...
class SkrivVedtaksbrevKlageLøsning(
    ...
    override fun løs(repositoryProvider: RepositoryProvider, kontekst: AvklaringsbehovKontekst, gatewayProvider: GatewayProvider): LøsningsResultat {
        return SkrivVedtaksbrevKlageLøser(repositoryProvider, gatewayProvider).løs(kontekst, this)
    }
}