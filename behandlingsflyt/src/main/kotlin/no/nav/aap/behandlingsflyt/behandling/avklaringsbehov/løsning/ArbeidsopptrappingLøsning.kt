...
import no.nav.aap.behandlingsflyt.faktagrunnlag.saksbehandler.arbeidsopptrapping.ArbeidsopptrappingDto
...
class ArbeidsopptrappingLøsning(
    @param:JsonProperty(
        "arbeidsopptrappingVurderinger",
        required = true
    ) val arbeidsopptrappingVurderinger: List<ArbeidsopptrappingDto>,
    @param:JsonProperty(
        "behovstype",
        required = true,
