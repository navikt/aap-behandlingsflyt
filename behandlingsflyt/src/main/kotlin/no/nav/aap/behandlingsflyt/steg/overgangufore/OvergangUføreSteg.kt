...
import no.nav.aap.beregning.tilTidslinje
...
import no.nav.aap.overganguføre.OvergangUføreValidering
...
class OvergangUføreSteg private constructor(
    ...
    private fun perioderSomIkkeErTilstrekkeligVurdert(kontekst: FlytKontekstMedPerioder): Set<Periode> {
        ...
        val nårVurderingErKonsistent = OvergangUføreValidering.nårVurderingErKonsistentMedSykdomOgBistand(
