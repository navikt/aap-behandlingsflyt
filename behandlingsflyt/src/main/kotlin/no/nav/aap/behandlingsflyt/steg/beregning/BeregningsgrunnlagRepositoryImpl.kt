...
import no.nav.aap.beregning.UføreInntektPeriodisert
...
VALUES (?, ?, ?, ?, ?, ?, ?)"""
        ...
        connection.executeBatch(
            """
            INSERT INTO beregning_ufore_uforegrader (beregning_ufore_id, uforegrad, virkningstidspunkt, uforegrad_fom, uforegrad_tom)
            values  (?, ?, ?, ?, ?)
