...
import no.nav.aap.behandlingsflyt.avklaringsbehov.løser.AvklarSamordningArbeidsgiverLøser
...
class AvklarSamordningArbeidsgiverLøsning(
    @param:JsonProperty(
        ...
        required = true
    ) val samordningArbeidsgiverVurdering: SamordningArbeidsgiverVurderingerDTO,
