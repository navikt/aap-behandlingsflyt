...
class RefusjonkravSteg private constructor(
    ...
    override fun utfør(kontekst: FlytKontekstMedPerioder): StegResultat {
        ...
        val sykdomsvurderinger = sykdomRepository.hentHvisEksisterer(kontekst.behandlingId)?.sykdomsvurderinger.orEmpty()
        ...
        when (kontekst.vurderingType) {
            ...
            VurderingType.REVURDERING -> {
                ...
                if (tidligereVurderinger.girIngenBehandlingsgrunnlag(kontekst, type())) {
                    avklaringsbehovRepository.hentAvklaringsbehovene(kontekst.behandlingId).avbrytForSteg(type())
                }
            }
