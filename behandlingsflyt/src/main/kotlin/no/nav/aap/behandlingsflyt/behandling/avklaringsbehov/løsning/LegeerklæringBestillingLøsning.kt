...
import no.nav.aap.behandlingsflyt.behandling.avklaringsbehov.løser.LegeerklæringBestillingLøser
...
class LegeerklæringBestillingLøsning(
    @JsonProperty("behovstype", required = true, defaultValue = BESTILL_LEGEERKLÆRING_KODE
