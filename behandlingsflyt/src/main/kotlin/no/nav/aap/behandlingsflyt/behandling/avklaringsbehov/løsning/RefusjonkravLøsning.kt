...
class RefusjonkravLøsning(
    @JsonProperty("refusjonkravVurderinger", required = true) val refusjonkravVurderinger: List<RefusjonkravVurdering>,
    @JsonProperty(
        "behovstype",
        required = true,
    ...
    override fun løs(connection: DBConnection, kontekst: AvklaringsbehovKontekst): LøsningsResultat {
        return RefusjonkravLøser(connection).løs(kontekst, this)
    }
}
