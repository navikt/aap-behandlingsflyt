 ...
 * @param gradering Reduksjon basert på timer arbeid. 100% - max(andelArbeid, fastsattArbeidsevne). Er 0 hvis søker har jobbet mer enn grenseverdi eller ikke har levert timer. Konstant for hele meldeperioden.
