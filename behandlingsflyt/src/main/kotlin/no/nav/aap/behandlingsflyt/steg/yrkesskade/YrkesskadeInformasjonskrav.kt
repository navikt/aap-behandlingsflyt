...
class YrkesskadeInformasjonskrav internal constructor(
...
) : Informasjonskrav<YrkesskadeInformasjonskrav.YrkesskadeInput, YrkesskadeInformasjonskrav.YrkesskadeRegisterdata> {
    ...
    override fun oppdater(
        ...
        return if (nyeData == gamleData) Endret.IKKE_ENDRET else Endret.ENDRET
    }
