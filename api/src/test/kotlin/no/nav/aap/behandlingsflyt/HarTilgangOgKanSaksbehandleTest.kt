...
//        )
//
//        val behandling = InMemoryBehandlingRepository.hent(BehandlingId(1))
//        
...
//            harTilgangOgKanSaksbehandle(behandling, harTilgang = true, avklaringsbehovene = avklaringsbehovene)
//
...
//        val behandling = InMemoryBehandlingRepository.hent(BehandlingId(1))
//        val harTilgangTilÅSaksbehandle =
//            harTilgangOgKanSaksbehandle(behandling = behandling, harTilgang = true, avklaringsbehovene = avklaringsbehovene)
//
//        assertThat(harTilgangTilÅSaksbehandle).isFalse()
//    }
//
