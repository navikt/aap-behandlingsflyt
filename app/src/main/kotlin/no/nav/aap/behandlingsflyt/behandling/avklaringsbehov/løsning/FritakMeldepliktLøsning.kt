...
class FritakMeldepliktLøsning(
    @JsonProperty("fritaksvurdering", required = true) fritaksvurderingDto: FritaksvurderingDto,
    ...
    @JsonIgnore
    internal val fritaksvurdering = fritaksvurderingDto.toFritaksvurdering()

    override fun løs(connection: DBConnection, kontekst: AvklaringsbehovKontekst): LøsningsResultat {
        return FritakFraMeldepliktLøser(connection).løs(kontekst, this)
    }

    internal fun fritaksPerioder() = fritaksvurdering.fritaksPerioder
}
