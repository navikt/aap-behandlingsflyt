...
import no.nav.aap.behandlingsflyt.avklaringsbehov.løsning.AvklarSoningsforholdLøsning
...
class TestScenarioOrkestrator(
    ...
    fun løsManuellInntektVurdering(behandling: Behandling, manglendeInntektsÅr: List<Int>): Behandling {
        return løsAvklaringsBehov(
            behandling,
