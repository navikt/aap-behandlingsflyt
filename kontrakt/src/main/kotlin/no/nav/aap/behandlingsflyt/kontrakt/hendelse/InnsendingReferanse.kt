...
public data class InnsendingReferanse(
    ...
    public constructor(id: ForeldrepengevedtakReferanse) : this(Type.FORELDREPENGEVEDTAK_HENDELSE_ID, id.asString)
...
public data class ForeldrepengevedtakReferanse(@JsonValue val value: String) {
    val asString: String get() = value

    public companion object {
        public fun ny(meldingKey: String): ForeldrepengevedtakReferanse = ForeldrepengevedtakReferanse(meldingKey)
    }
}
