...
(
    ...
    SKAL_GJENOPPTA_STUDIE TEXT NULL
);
...
(
    ...
    GODKJENT_STUDIE_AV_LAANEKASSEN  BOOLEAN NOT NULL,
    AVBRUTT_PGA_SYKDOM_ELLER_SKADE  BOOLEAN NOT NULL,
    HAR_BEHOV_FOR_BEHANDLING    BOOLEAN NOT NULL,
    SKAL_GJENOPPTA_STUDIE   BOOLEAN NOT NULL,
    AVBRUTT_DATO DATE      NOT NULL,
    AVBRUDD_MER_ENN_6_MAANEDER BOOLEAN NOT NULL
);
...
(
    ID                                     BIGSERIAL   NOT NULL PRIMARY KEY,
    BEGRUNNELSE                            TEXT        NOT NULL,
    ER_ARBEIDSEVNE_NEDSATT                 BOOLEAN     NOT NULL,
    ER_SYKDOM_SKADE_LYTE_VESETLING_DEL     BOOLEAN     NULL,
