...
CREATE UNIQUE INDEX UIDX_SAMORDNING_YTELSEVURDERING_GRUNNLAG_BEHANDLING_ID ON SAMORDNING_YTELSEVURDERING_GRUNNLAG (BEHANDLING_ID) WHERE (AKTIV = TRUE);
...
CREATE UNIQUE INDEX UIDX_SAMORDNING_VURDERING_VURDERINGER_ID ON SAMORDNING_VURDERING (VURDERINGER_ID);
...
CREATE UNIQUE INDEX UIDX_SAMORDNING_YTELSE_YTELSER_ID ON SAMORDNING_YTELSE (YTELSER_ID);