...
(
    ...
    VIRKSOMHET_NAVN                     varchar(50)                            NOT NULL,
    ORG_NR                              BIGINT                                 NULL,
    EGEN_VIRKSOMHET_UTVIKLING_PERIODER  BIGINT                                 NULL REFERENCES EGEN_VIRKSOMHET_UTVIKLING_PERIODER (ID),
    EGEN_VIRKSOMHET_OPPSTART_PERIODER   BIGINT                                 NULL REFERENCES EGEN_VIRKSOMHET_OPPSTART_PERIODER (ID),
