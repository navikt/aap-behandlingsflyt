...
(
    ...
    VURDERT_AV                     TEXT           NOT NULL DEFAULT 'Ukjent',
    MANUELL_INNTEKT_VURDERINGER_ID BIGINT         NOT NULL REFERENCES MANUELL_INNTEKT_VURDERINGER (ID),
    OPPRETTET_TID                  TIMESTAMP(3)   NOT NULL DEFAULT CURRENT_TIMESTAMP
);

-- Kun én manuell vurdering per år
CREATE UNIQUE INDEX UIDX_MANUELL_INNTEKT_VURDERING ON MANUELL_INNTEKT_VURDERING (AR, MANUELL_INNTEKT_VURDERINGER_ID);
